...
// ─── yagura_unregister (additional) ───────────────────────────

// ─── yagura_update (additional) ──────────────────────────────

// ─── yagura_stats (additional) ────────────────────────────────

// ─── yagura_vulns (S1.2 OSV vulnerability scan) ──────────────

// ─── yagura_scorecard (S1.1 OpenSSF Scorecard fetch) ─────────

// ─── yagura_health (portfolio security summary) ──────────────

// projectHealthSummary は 1 プロジェクトの security 状態を返す。
...
// ─── yagura_heartbeat (v0.14.0) ──────────────────────────────

// ─── yagura_quota_forecast (v0.15.0) ─────────────────────────

// ─── yagura_usage_summary (v0.16.0) ──────────────────────────
