...
call. This adds nothing to the core — the daemon and the 78 MCP tools are
...
Yagura is agent-agnostic. Its 78 MCP tools work with **any** MCP client, and the
...
├── internal/                # 72 packages, none exported
