...
Status: **v0.36.0** — 62 MCP tools, 51 internal packages, CLI direct mode + `ai-verify`/`quality-check`, 31 consecutive reproducible releases.
...
├── internal/                # 51 packages, none exported
