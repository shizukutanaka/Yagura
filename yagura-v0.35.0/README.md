...
call. This adds nothing to the core — the daemon and the 85 MCP tools are
...
Yagura is agent-agnostic. Its 85 MCP tools work with **any** MCP client, and the
...
├── internal/                # 79 packages, none exported
