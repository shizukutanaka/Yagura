...
yagura is a long-running daemon that manages m's 23+ project portfolio. It exposes 102 MCP tools. Call them via the local MCP endpoint instead of guessing portfolio state from memory.
